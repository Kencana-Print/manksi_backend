...
const saveData = async (payload, user) => {
  ...
  try {
    ...
    if (!isEdit) {
      ...
      // Semua divisi (termasuk Spanduk/MMT) sekarang mewarisi nomor
      // dari SO sumbernya — sama persis pola Garmen, supaya nomor
      // SPK dan SO selalu identik (cuma prefix "SO-" -> "SPK-").
      // isLegacySpkFlow TIDAK lagi dipakai untuk generate nomor
      // (masih dipakai di tempat lain untuk keperluan flow/tab UI).
