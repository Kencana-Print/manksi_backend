const svc = require("../../../services/laporan/marketing/realisasiPengirimanMemoService");
...
const updateReason = async (req, res) => {
  try {
    const { mapNomor, reason } = req.body;
    const data = await svc.updateReason(mapNomor, reason);
