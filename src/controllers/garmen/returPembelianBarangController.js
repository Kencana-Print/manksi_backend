const returPembelianBarangService = require("../../services/garmen/returPembelianBarangService");
...
const getBrowse = async (req, res) => {
  try {
    ...
    const data = await returPembelianBarangService.getBrowseData(
      startDate,
      endDate,
      cabang,
      jenis,
...
const deleteData = async (req, res) => {
  try {
    ...
    await returPembelianBarangService.deleteData(nomor, req.user);
...
const requestEdit = async (req, res) => {
  try {
    ...
    await returPembelianBarangService.ajukanPerubahan(req.body, req.user);
    res
      .status(200)
