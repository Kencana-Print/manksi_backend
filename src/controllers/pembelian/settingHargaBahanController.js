...
const getBiayaJahitGarmen = async (req, res) => {
    try {
        const data = await service.getBiayaJahitGarmen();
        res.json({ success: true, data });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
    }
...
const createKainGarmen = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Harga kain garmen berhasil ditambahkan",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const updateKainGarmen = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Harga kain garmen berhasil diperbarui",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const deleteKainGarmen = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Harga kain garmen berhasil dihapus",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const createTambahanGarmen = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Biaya tambahan garmen berhasil ditambahkan",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const updateTambahanGarmen = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Biaya tambahan garmen berhasil diperbarui",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const deleteTambahanGarmen = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Biaya tambahan garmen berhasil dihapus",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const createSpanduk = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Strata harga spanduk berhasil ditambahkan",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const updateSpanduk = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Strata harga spanduk berhasil diperbarui",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const deleteSpanduk = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Strata harga spanduk berhasil dihapus",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const createMmt = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Strata bahan MMT berhasil ditambahkan",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const updateMmt = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Strata bahan MMT berhasil diperbarui",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const deleteMmt = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Strata bahan MMT berhasil dihapus",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const createMmtTambahan = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Topping MMT berhasil ditambahkan",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const updateMmtTambahan = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Topping MMT berhasil diperbarui",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const deleteMmtTambahan = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Topping MMT berhasil dihapus",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
...
const updateMarginGarmen = async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            message: "Margin garmen berhasil diperbarui",
            data: result,
        });
    } catch (err) {
        res.status(500).json({ success: false, message: err.message });
